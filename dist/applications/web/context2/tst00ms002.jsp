...
function getCpaDetail() {
	...
	var myAjax = new Ajax.Request( './tst20ac002.jsp', opt);
...
<table class="TableLayout">
  <tr>
    <td width="180" class="Title" ><img src="images/bu_tit.gif" ><%=_i18n.get("menu.test.eb.self")%></td>
