...
//        return;
   ...
   var opt = {
      ...
      onSuccess: function(t) {
        closeInfo();
    	$('messageDisplay').innerHTML = '<img src="images/bu_query.gif" align="absmiddle" > <%=_i18n.get("agr10ms001.register.ok") %>';
    	Dialog.setInfoMessage('<%=_i18n.get("agr10ms001.register.ok") %>');
   ...
   var myAjax = new Ajax.Request("agr10ac001.jsp", opt);
}
...
function changeRef() {
	...
	//$('id').disabled = state ;
	//$('id').style.backgroundColor = state?"white":"white" ;
...
<table class="TableLayout">
  <tr>
    <td width="25%" class="Title" ><img src="images/bu_tit.gif" ><%=_i18n.get("menu.agreement.register")%></td>
...
<table class="TableLayout" >
  <tr>
    <td align="right" style="padding-top:15">
      ...
      <a href="javascript:insertAgreement()"><img src="images/btn_big_create.gif" width="39" height="23" border="0"></a>
