...
<input type="hidden" name="pullMode" id="pullMode" value="<%= Eb3Constants.PULLING_MODE_RECEIVED %>">
<input type="hidden" name="f_date" id="f_date" value="1980-01-01">
<!-- 제목 테이블 -->
<table class="TableLayout">
  <tr>
    <td width="200" class="Title" ><img src="images/bu_tit.gif" ><%=_i18n.get("menu.msg.pullrecv.list")%></td>
