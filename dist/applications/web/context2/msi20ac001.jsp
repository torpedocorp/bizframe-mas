...
// ============ get subscribers list ================
   String cpa_name   = (String)request.getParameter("cpaName");
   String cpa_status = (String)request.getParameter("cpaStatus");
   ...
   try {
      ...
      if(cpa_name != null   && !cpa_name.equals(""))     qc.add("cpa_name", cpa_name);
      if(cpa_status != null && !cpa_status.equals(""))   qc.add("status", cpa_status);
	  MxsEngine engine = MxsEngine.getInstance();
      array       = engine.getObjects("Cpa", qc, DAOFactory.EBMS);
	...
	for (int i=startNum; i<=endNum; i++) {
      ...
      cpaJS.put("userId",        cpaVO.getUserId()==null?"":cpaVO.getUserId());
