...
function getWsdl() {
	var opt = {
		method: 'get',
		parameters: 'wsdltype=1&item_Cnt=999',
...
function sendMessage() {
	document.form1.action = "tst21ms901.jsp";
	...
	var myAjax = new Ajax.Request( './tst21ms901.jsp', opt);
	*/
}
...
<table class="FieldTable">
  ...
  <tr>
    <td width="120" class="FieldLabel"><%= _i18n.get("global.msg.ssl") %></td>
    <td colspan="2" class="FieldData">
      <input type="radio" name="ssl_use" id="ssl_use" value="0" checked><%= _i18n.get("global.not.use") %>&nbsp;&nbsp;
      <input type="radio" name="ssl_use" id="ssl_use" value="1"><%= _i18n.get("global.use") %>
		(* <%= _i18n.get("global.msg.sslcomment") %>)</td>
  </tr>
  <tr>
    <td width="120" class="FieldLabel"><%= _i18n.get("global.msg.signature") %></td>
    <td colspan="3" class="FieldData">
      <input type="radio" name="dsig_use" id="dsig_use" value="0" checked><%= _i18n.get("global.not.use") %>&nbsp;&nbsp;
      <input type="radio" name="dsig_use" id="dsig_use" value="1"><%= _i18n.get("global.use") %></td>
    </td>
  </tr>
  <tr>
